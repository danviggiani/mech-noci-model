...
SIM_T = 10     # Simulation time in s
RES = 0.0002        # Resolution in seconds
Q = int(SIM_T / RES)    # Number of samples in the simulation
I_tonic = 1.8     # Input current for tonic inhibitors in nA
P = 100           # Number of iterations
Z = 1.0        # To scale terms in sensitivity analysis
...
#PPTv = PPT(np.linspace(0.05, 0.5, P)) # in MPa
...
# Includes, axon diameter, axon length, refractory period, activation threshold,and the myelination/brainstem parameters
NIdx = [{'name' : 'AB', 'diam' : random.gauss(9.0, 1.5), 'axonl' : random.randint(95, 102), 'refractory_period' : random.randint(5, 7) / 1000, 'activation_threshold' : random.gauss(30.0, 2.5), 'sens' : 0.00001,'I_tonic' : 0, 'myelinated' : True, 'primary_afferent' : True, 'is_noci' : False, 'is_brainstem' : False},    #N0, Primary AB
        {'name' : 'Ad', 'diam' : random.gauss(3.5, 1.0), 'axonl' : random.randint(95, 102), 'refractory_period' : random.randint(7, 12) / 1000, 'activation_threshold' : random.gauss(30.0, 2.5), 'sens' : 0.5, 'I_tonic' : 0, 'myelinated' : True, 'primary_afferent' : True, 'is_noci' : True, 'is_brainstem' : False},   #N1 Primary Ad
        {'name' : 'Cn', 'diam' : random.gauss(0.3, 0.1), 'axonl' : random.randint(95, 102), 'refractory_period' : random.randint(7, 12) / 1000, 'activation_threshold' : random.gauss(30.0, 2.5), 'sens' : 0.5, 'I_tonic' : 0, 'myelinated' : False, 'primary_afferent' : True, 'is_noci' : True, 'is_brainstem' : False},    #N2 Primary C
        {'name' : 'PN', 'diam' : random.gauss(7.0, 1.5), 'axonl' : random.randint(950, 1025), 'refractory_period' : random.randint(5, 10) / 1000, 'activation_threshold' : random.gauss(30.0, 2.5), 'sens' : 0.5, 'I_tonic' : 0, 'myelinated' : True, 'primary_afferent' : False, 'is_noci' : True, 'is_brainstem' : False},   #N3 Projection Neuron
        {'name' : 'VC', 'diam' : random.gauss(7.0, 1.5), 'axonl' : random.randint(5, 40), 'refractory_period' : random.randint(5, 10) / 1000, 'activation_threshold' : random.gauss(30.0, 2.5), 'sens' : 0.5, 'I_tonic' : 0, 'myelinated' : True, 'primary_afferent' : False, 'is_noci' : True, 'is_brainstem' : False},       #N4 Vertical Cell
        {'name' : 'II', 'diam' : random.gauss(7.0, 1.5), 'axonl' : random.randint(5, 40), 'refractory_period' : random.randint(5, 10) / 1000, 'activation_threshold' : random.gauss(30.0, 2.5), 'sens' : 0.5, 'I_tonic' : 0, 'myelinated' : True, 'primary_afferent' : False, 'is_noci' : True, 'is_brainstem' : False},       #N5 Secondary Inhibitor
        {'name' : 'TI', 'diam' : random.gauss(7.0, 1.5), 'axonl' : random.randint(5, 40), 'refractory_period' : random.randint(5, 10) / 1000, 'activation_threshold' : random.gauss(30.0, 2.5), 'sens' : 0.5, 'I_tonic' : I_tonic, 'myelinated' : True, 'primary_afferent' : False, 'is_noci' : True, 'is_brainstem' : False},       #N6 Tonic Inhibitor
        {'name' : 'BN', 'diam' : random.gauss(7.0, 1.5), 'axonl' : random.randint(5, 40), 'refractory_period' : random.randint(5, 10) / 1000, 'activation_threshold' : random.gauss(30.0, 2.5), 'sens' : 0.5, 'I_tonic' : 0, 'myelinated' : True, 'primary_afferent' : False, 'is_noci' : True, 'is_brainstem' : True}]       #N7 Brainstem
...
def LinPPT(ppt, dP = 0.2, l0 = 5.0):
    ...
    #   l2 is the linear decreasing frunciton from "ppt" beack down to 0
...
class Neuron:
    ...
    def Spike(self, current_time, current_q, ow):
        ...
        Inputs:
            "current_time" is the current timepoint in milliseconds, should correspond to the "current_q"
    ...
    def PlotVm(self, xtra = True):
        ...
        plt.plot(x, self.membrane_potential, label = self.name)
